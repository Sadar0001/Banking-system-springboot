...
INSERT INTO charges_book (fee_name, fee_amount, bank_id, bank_type, transaction_type, min_value, max_value, is_active, created_at, updated_at) VALUES
                                                                                                                                                   ...
                                                                                                                                                   ('Large Transaction Fee', 20.00, 1, 'CENTRAL_BANK', 'TRANSFER', 1000000.0, 100000000.0, true, NOW(), NOW());


-- ==============================
-- CORRECTED TRANSACTIONS & CHARGES DATA
-- ==============================
-- This uses the correct account IDs from your account table
-- Account IDs are sequential: 1, 2, 3, 4, 5, 6... (NOT customer IDs)

-- ==============================
-- Transaction 1: Small Transfer within SBI
-- From: Account ID 1 (Rahul Sharma - SBI001001SAV001)
-- To: Account ID 3 (Priya Patil - SBI001002SAV001)
-- Amount: ₹2,000 | Charge: ₹10 (Small Transfer Fee from Branch 1)
-- ==============================
INSERT INTO transactions (from_account_id, to_account_id, transaction_type, amount, currency, description,
                          transaction_reference, total_charges, status, fee_amount, net_amount,
                          transaction_date, created_at)
VALUES (1, 3, 'TRANSFER', 2000.00, 'INR', 'Payment for birthday gift',
        'TXN1730102400000-A1B2C3D4', 10.00, 'COMPLETED', 10.00, 2000.00,
        '2024-10-28 10:15:30', '2024-10-28 10:15:30');

-- Charges for Transaction 1
INSERT INTO charges (transaction_id, bank_type, charged_amount, bank_id, created_at)
VALUES (1, 'BANK_BRANCH', 10.00, 1, '2024-10-28 10:15:30');

-- ==============================
-- Transaction 2: Medium Transfer within SBI
-- From: Account ID 5 (Amit Verma - SBI002001SAV001)
-- To: Account ID 7 (Neha Singh - SBI002002SAV001)
-- Amount: ₹15,000 | Charge: ₹25 (Medium Transfer Fee from Branch 2)
-- ==============================
INSERT INTO transactions (from_account_id, to_account_id, transaction_type, amount, currency, description,
                          transaction_reference, total_charges, status, fee_amount, net_amount,
                          transaction_date, created_at)
VALUES (5, 7, 'TRANSFER', 15000.00, 'INR', 'Loan repayment',
        'TXN1730188800000-E5F6G7H8', 25.00, 'COMPLETED', 25.00, 15000.00,
        '2024-10-29 14:20:45', '2024-10-29 14:20:45');

-- Charges for Transaction 2
INSERT INTO charges (transaction_id, bank_type, charged_amount, bank_id, created_at)
VALUES (2, 'BANK_BRANCH', 25.00, 2, '2024-10-29 14:20:45');

-- ==============================
-- Transaction 3: Cross-Bank Transfer (SBI to PNB)
-- From: Account ID 1 (Rahul Sharma - SBI001001SAV001)
-- To: Account ID 9 (Sanjay Gupta - PNB001001SAV001)
-- Amount: ₹5,000 | Charge: ₹20 (Standard Transfer Fee from Branch 1)
-- ==============================
INSERT INTO transactions (from_account_id, to_account_id, transaction_type, amount, currency, description,
                          transaction_reference, total_charges, status, fee_amount, net_amount,
                          transaction_date, created_at)
VALUES (1, 9, 'TRANSFER', 5000.00, 'INR', 'Business payment',
        'TXN1730275200000-I9J0K1L2', 25.00, 'COMPLETED', 25.00, 5000.00,
        '2024-10-30 09:30:15', '2024-10-30 09:30:15');

-- Charges for Transaction 3
INSERT INTO charges (transaction_id, bank_type, charged_amount, bank_id, created_at)
VALUES (3, 'BANK_BRANCH', 25.00, 1, '2024-10-30 09:30:15');

-- ==============================
-- Transaction 4: ATM Withdrawal
-- From: Account ID 3 (Priya Patil - SBI001002SAV001)
-- To: Account ID 3 (Priya Patil - SBI001002SAV001)
-- Amount: ₹3,000 | Charge: ₹5 (ATM Withdrawal Fee)
-- ==============================
INSERT INTO transactions (from_account_id, to_account_id, transaction_type, amount, currency, description,
                          transaction_reference, total_charges, status, fee_amount, net_amount,
                          transaction_date, created_at)
VALUES (3, 3, 'WITHDRAWAL', 3000.00, 'INR', 'ATM Withdrawal',
        'TXN1730361600000-M3N4O5P6', 5.00, 'COMPLETED', 5.00, 3000.00,
        '2024-10-31 11:45:00', '2024-10-31 11:45:00');

-- Charges for Transaction 4
INSERT INTO charges (transaction_id, bank_type, charged_amount, bank_id, created_at)
VALUES (4, 'BANK_BRANCH', 5.00, 1, '2024-10-31 11:45:00');

-- ==============================
-- Transaction 5: Large Transfer within PNB
-- From: Account ID 13 (Rohit Kumar - PNB002001CUR001)
-- To: Account ID 11 (Pooja Sharma - PNB001002SAV001)
-- Amount: ₹75,000 | Charge: ₹45 (Premium Transfer Fee from Branch 6)
-- ==============================
INSERT INTO transactions (from_account_id, to_account_id, transaction_type, amount, currency, description,
                          transaction_reference, total_charges, status, fee_amount, net_amount,
                          transaction_date, created_at)
VALUES (13, 11, 'TRANSFER', 75000.00, 'INR', 'Investment payment',
        'TXN1730448000000-Q7R8S9T0', 45.00, 'COMPLETED', 45.00, 75000.00,
        '2024-11-01 13:10:20', '2024-11-01 13:10:20');

-- Charges for Transaction 5
INSERT INTO charges (transaction_id, bank_type, charged_amount, bank_id, created_at)
VALUES (5, 'BANK_BRANCH', 45.00, 6, '2024-11-01 13:10:20');

-- ==============================
-- Transaction 6: Deposit Transaction
-- From: Account ID 5 (Amit Verma - SBI002001SAV001)
-- To: Account ID 5 (Amit Verma - SBI002001SAV001)
-- Amount: ₹25,000 | Charge: ₹0 (Cash Deposit - Free under 50K)
-- ==============================
INSERT INTO transactions (from_account_id, to_account_id, transaction_type, amount, currency, description,
                          transaction_reference, total_charges, status, fee_amount, net_amount,
                          transaction_date, created_at)
VALUES (5, 5, 'DEPOSIT', 25000.00, 'INR', 'Cash deposit at branch',
        'TXN1730534400000-U1V2W3X4', 0.00, 'COMPLETED', 0.00, 25000.00,
        '2024-11-02 15:25:40', '2024-11-02 15:25:40');

-- Charges for Transaction 6 (Zero charge)
INSERT INTO charges (transaction_id, bank_type, charged_amount, bank_id, created_at)
VALUES (6, 'BANK_BRANCH', 0.00, 2, '2024-11-02 15:25:40');

-- ==============================
-- Transaction 7: Small Transfer in BOB
-- From: Account ID 17 (Raj Patel - BOB001001SAV001)
-- To: Account ID 19 (Mira Desai - BOB001002SAV001)
-- Amount: ₹1,500 | Charge: ₹5 (Micro Transfer Fee from Branch 9)
-- ==============================
INSERT INTO transactions (from_account_id, to_account_id, transaction_type, amount, currency, description,
                          transaction_reference, total_charges, status, fee_amount, net_amount,
                          transaction_date, created_at)
VALUES (17, 19, 'TRANSFER', 1500.00, 'INR', 'Grocery payment',
        'TXN1730620800000-Y5Z6A7B8', 5.00, 'COMPLETED', 5.00, 1500.00,
        '2024-11-03 10:40:55', '2024-11-03 10:40:55');

-- Charges for Transaction 7
INSERT INTO charges (transaction_id, bank_type, charged_amount, bank_id, created_at)
VALUES (7, 'BANK_BRANCH', 5.00, 9, '2024-11-03 10:40:55');

-- ==============================
-- Transaction 8: Medium Transfer in BOB
-- From: Account ID 17 (Raj Patel - BOB001001SAV001)
-- To: Account ID 19 (Mira Desai - BOB001002SAV001)
-- Amount: ₹12,000 | Charge: ₹15 (Small Transfer Fee from Branch 9, 2K-20K range)
-- ==============================
INSERT INTO transactions (from_account_id, to_account_id, transaction_type, amount, currency, description,
                          transaction_reference, total_charges, status, fee_amount, net_amount,
                          transaction_date, created_at)
VALUES (17, 19, 'TRANSFER', 12000.00, 'INR', 'Medical bills payment',
        'TXN1730707200000-C9D0E1F2', 15.00, 'COMPLETED', 15.00, 12000.00,
        '2024-11-04 08:15:30', '2024-11-04 08:15:30');

-- Charges for Transaction 8
INSERT INTO charges (transaction_id, bank_type, charged_amount, bank_id, created_at)
VALUES (8, 'BANK_BRANCH', 15.00, 9, '2024-11-04 08:15:30');

-- ==============================
-- Transaction 9: Transfer in Canara Bank
-- From: Account ID 21 (Arun Kumar - CAN001001SAV001)
-- To: Account ID 23 (Lakshmi Nair - CAN001002SAV001)
-- Amount: ₹8,500 | Charge: ₹12 (Express Transfer Fee from Branch 13)
-- ==============================
INSERT INTO transactions (from_account_id, to_account_id, transaction_type, amount, currency, description,
                          transaction_reference, total_charges, status, fee_amount, net_amount,
                          transaction_date, created_at)
VALUES (21, 23, 'TRANSFER', 8500.00, 'INR', 'Rent payment',
        'TXN1730620805000-G3H4I5J6', 12.00, 'COMPLETED', 12.00, 8500.00,
        '2024-11-02 16:30:20', '2024-11-02 16:30:20');

-- Charges for Transaction 9
INSERT INTO charges (transaction_id, bank_type, charged_amount, bank_id, created_at)
VALUES (9, 'BANK_BRANCH', 12.00, 13, '2024-11-02 16:30:20');

-- ==============================
-- Transaction 10: Large Transfer in Canara Bank
-- From: Account ID 22 (Arun Kumar - CAN001001CUR001)
-- To: Account ID 23 (Lakshmi Nair - CAN001002SAV001)
-- Amount: ₹45,000 | Charge: ₹35 (Premium Transfer Fee from Branch 13, 10K-100K range)
-- ==============================
INSERT INTO transactions (from_account_id, to_account_id, transaction_type, amount, currency, description,
                          transaction_reference, total_charges, status, fee_amount, net_amount,
                          transaction_date, created_at)
VALUES (22, 23, 'TRANSFER', 45000.00, 'INR', 'Business investment',
        'TXN1730534410000-K7L8M9N0', 35.00, 'COMPLETED', 35.00, 45000.00,
        '2024-11-01 18:45:10', '2024-11-01 18:45:10');

-- Charges for Transaction 10
INSERT INTO charges (transaction_id, bank_type, charged_amount, bank_id, created_at)
VALUES (10, 'BANK_BRANCH', 35.00, 13, '2024-11-01 18:45:10');

-- ==============================
-- Transaction 11: Transfer in Axis Bank
-- From: Account ID 25 (Rohan Malhotra - AXS001001CUR001)
-- To: Account ID 27 (Nidhi Chawla - AXS001002SAV001)
-- Amount: ₹3,500 | Charge: ₹7 (Quick Transfer Fee from Branch 17)
-- ==============================
INSERT INTO transactions (from_account_id, to_account_id, transaction_type, amount, currency, description,
                          transaction_reference, total_charges, status, fee_amount, net_amount,
                          transaction_date, created_at)
VALUES (25, 27, 'TRANSFER', 3500.00, 'INR', 'Dinner payment',
        'TXN1730361620000-O1P2Q3R4', 7.00, 'COMPLETED', 7.00, 3500.00,
        '2024-10-30 12:20:15', '2024-10-30 12:20:15');

-- Charges for Transaction 11
INSERT INTO charges (transaction_id, bank_type, charged_amount, bank_id, created_at)
VALUES (11, 'BANK_BRANCH', 7.00, 17, '2024-10-30 12:20:15');

-- ==============================
-- Transaction 12: Large Transfer in Axis Bank
-- From: Account ID 25 (Rohan Malhotra - AXS001001CUR001)
-- To: Account ID 27 (Nidhi Chawla - AXS001002SAV001)
-- Amount: ₹85,000 | Charge: ₹40 (Priority Transfer Fee from Branch 17, 50K-500K range)
-- ==============================
INSERT INTO transactions (from_account_id, to_account_id, transaction_type, amount, currency, description,
                          transaction_reference, total_charges, status, fee_amount, net_amount,
                          transaction_date, created_at)
VALUES (25, 27, 'TRANSFER', 85000.00, 'INR', 'Property down payment',
        'TXN1730448020000-S5T6U7V8', 40.00, 'COMPLETED', 40.00, 85000.00,
        '2024-10-31 20:10:45', '2024-10-31 20:10:45');

-- Charges for Transaction 12
INSERT INTO charges (transaction_id, bank_type, charged_amount, bank_id, created_at)
VALUES (12, 'BANK_BRANCH', 40.00, 17, '2024-10-31 20:10:45');

-- ==============================
-- Transaction 13: Bill Payment in SBI
-- From: Account ID 2 (Rahul Sharma - SBI001001CUR001)
-- To: Account ID 3 (Priya Patil - SBI001002SAV001)
-- Amount: ₹18,000 | Charge: ₹25 (Medium Transfer Fee from Branch 1)
-- ==============================
INSERT INTO transactions (from_account_id, to_account_id, transaction_type, amount, currency, description,
                          transaction_reference, total_charges, status, fee_amount, net_amount,
                          transaction_date, created_at)
VALUES (2, 3, 'BILL_PAYMENT', 18000.00, 'INR', 'Electricity bill payment',
        'TXN1730275230000-W9X0Y1Z2', 25.00, 'COMPLETED', 25.00, 18000.00,
        '2024-10-29 17:55:30', '2024-10-29 17:55:30');

-- Charges for Transaction 13
INSERT INTO charges (transaction_id, bank_type, charged_amount, bank_id, created_at)
VALUES (13, 'BANK_BRANCH', 25.00, 1, '2024-10-29 17:55:30');

-- ==============================
-- Transaction 14: Counter Withdrawal in PNB
-- From: Account ID 9 (Sanjay Gupta - PNB001001SAV001)
-- To: Account ID 9 (Sanjay Gupta - PNB001001SAV001)
-- Amount: ₹8,000 | Charge: ₹7 (Withdrawal Charge from Branch 5)
-- ==============================
INSERT INTO transactions (from_account_id, to_account_id, transaction_type, amount, currency, description,
                          transaction_reference, total_charges, status, fee_amount, net_amount,
                          transaction_date, created_at)
VALUES (9, 9, 'WITHDRAWAL', 8000.00, 'INR', 'Counter withdrawal',
        'TXN1730188830000-A3B4C5D6', 7.00, 'COMPLETED', 7.00, 8000.00,
        '2024-10-28 14:40:00', '2024-10-28 14:40:00');

-- Charges for Transaction 14
INSERT INTO charges (transaction_id, bank_type, charged_amount, bank_id, created_at)
VALUES (14, 'BANK_BRANCH', 7.00, 5, '2024-10-28 14:40:00');

-- ==============================
-- Transaction 15: Cross-Branch Transfer (PNB)
-- From: Account ID 9 (Sanjay Gupta - PNB001001SAV001)
-- To: Account ID 15 (Divya Reddy - PNB002002SAV001)
-- Amount: ₹25,000 | Charge: ₹20 (Standard Transfer Fee from Branch 5)
-- ==============================
INSERT INTO transactions (from_account_id, to_account_id, transaction_type, amount, currency, description,
                          transaction_reference, total_charges, status, fee_amount, net_amount,
                          transaction_date, created_at)
VALUES (9, 15, 'TRANSFER', 25000.00, 'INR', 'Family support',
        'TXN1730534440000-E7F8G9H0', 20.00, 'COMPLETED', 20.00, 25000.00,
        '2024-11-02 11:20:25', '2024-11-02 11:20:25');

-- Charges for Transaction 15
INSERT INTO charges (transaction_id, bank_type, charged_amount, bank_id, created_at)
VALUES (15, 'BANK_BRANCH', 20.00, 5, '2024-11-02 11:20:25');